...
// Detector parameters
    ...
    const G4double shape2_dxy = 10*cm, shape2_dz = 0.1*cm;
    const G4double env_sizeXY = 10*cm, env_sizeZ = 10*cm;
    const G4double sc_vol_st = 0.1*cm;
...
//========platic A-150-tissue  with incorporated Bi particles =======================
    ...
    const G4String Admixture_name = "G4_B";
    ...
    G4double  rho_admix = 2.34*g/cm3;
    G4double admix_c = 3000*mg/L; //concetration in  mg per Litre ++ as per Kolobov++++
